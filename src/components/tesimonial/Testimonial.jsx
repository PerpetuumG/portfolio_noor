          ...
          <div className={'w-full'}>
            <div className={'w-full h-auto flex flex-col lgl:flex-row justify-between'}>
              ...
              <div className={'w-full lgl:w-[60%] h-full flex flex-col justify-between'}>
                <img src={quote} alt='quote' className={'w-20 lgl:w-32'} />
                ...
                >
                  <div
                    className={
                      'flex justify-between lgl:items-center py-6 border-b-2 border-b-gray-900'
                    }
                  >
                    <div>
                  ...
                  >
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. A dolorum, eos natus
                    ipsum numquam veniam officia necessitatibus ratione quos debitis exercitationem
                    repudiandae facilis id neque nihil accusantium perspiciatis repellat? Iste.
                  </p>
                </div>
              </div>
            </div>
